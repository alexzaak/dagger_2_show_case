...
import codes.zaak.dagger2showcase.answer.di.TestAnswerModule
...
@MediumTest
class MainFragmentTestByOverride {
    ...
    fun setUp() {
        ...
        val testAppComponent = DaggerTestAppComponent
            .builder()
            .answerModule(TestAnswerModule(answerRepository = answerRepository))
            .build()
